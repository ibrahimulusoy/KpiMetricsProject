...
df = df[['EntityID', 'CDS00AR01219R']]
df.rename(columns={'EntityID': 'Campus_RowID', 'CDS00AR01219R': 'Raw_Score'}, inplace=True)
...
dfDistrict = dfDistrict[['DISTRICT', 'DDS00AR01219R']]
...
dfDistrict = dfDistrict[['DistrictID', 'DDS00AR01219R']]
dfDistrict.rename(columns={'DistrictID': 'DistrictKey', 'DDS00AR01219R': 'Raw_Score'}, inplace=True)
