"""
KPI: % of SPED(Special Ed) students with Meets or above in STAAR Reading
...
df = df[['EntityID', 'CDS00AR01S19R']]
df.rename(columns={'EntityID': 'Campus_RowID', 'CDS00AR01S19R': 'Raw_Score'}, inplace=True)
...
dfDistrict = dfDistrict[['DistrictID', 'DDS00AR01S19R']]
dfDistrict.rename(columns={'DistrictID': 'DistrictKey', 'DDS00AR01S19R': 'Raw_Score'}, inplace=True)
...
Bases.BaseKPI.setDistrictKPIDetails(dfDistrict, True, 80700020001)
