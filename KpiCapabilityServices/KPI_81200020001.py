...
df = pd.read_csv(r'{}\KPI_81200020001.csv'.format(Bases.BaseKPI.source_files_path))  # D:\UNC\KPI
...
df['Raw_Score_Details'] = 'CustomDev.KPI_81200020001'
df['Artifact_URL'] = 'SKYWARD'
Bases.BaseKPI.setKPIDetails(df, False, 81200020001, True)
