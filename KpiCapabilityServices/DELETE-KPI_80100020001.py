'''
KPI: Domain I (Student Achievement) scale score
...
dfCampus = dfCampus[['Campus_RowID', 'CD1S']]
dfCampus.rename(columns={'CD1S': 'Raw_Score'}, inplace=True)
dfCampus['Raw_Score_Details'] = ''
dfCampus['Artifact_URL'] = 'https://txschools.gov/schools'
Bases.BaseKPI.setKPIDetails(dfCampus, True, 80100020001, False)
...
dfDistrict = dfDistrict[['DistrictKey', 'DD1S']]
dfDistrict.rename(columns={'DD1S': 'Raw_Score'}, inplace=True)
dfDistrict['Raw_Score_Details'] = ''
dfDistrict['Artifact_URL'] = 'https://txschools.gov/schools'
Bases.BaseKPI.setDistrictKPIDetails(dfDistrict, True, 80100020001)
