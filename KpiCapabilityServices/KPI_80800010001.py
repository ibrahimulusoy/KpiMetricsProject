"""
KPI: % of ESL students with Meets or above in STAAR Math
...
df = df[['EntityID', 'CDL00AM01S19R']]
df.rename(columns={'EntityID': 'Campus_RowID', 'CDL00AM01S19R': 'Raw_Score'}, inplace=True)
...
Bases.BaseKPI.setKPIDetails(df, True, 80800010001, False)
...
dfDistrict = dfDistrict[['DISTRICT', 'DDL00AM01S19R']]
...
dfDistrict = dfDistrict[['DistrictID', 'DDL00AM01S19R']]
dfDistrict.rename(columns={'DistrictID': 'DistrictKey', 'DDL00AM01S19R': 'Raw_Score'}, inplace=True)
...
Bases.BaseKPI.setDistrictKPIDetails(dfDistrict, True, 80800010001)
