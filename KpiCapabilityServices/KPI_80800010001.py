...
df = df[['EntityID', 'CDL00AM01219R']]
df.rename(columns={'EntityID': 'Campus_RowID', 'CDL00AM01219R': 'Raw_Score'}, inplace=True)
...
dfDistrict = dfDistrict[['DISTRICT', 'DDL00AM01219R']]
...
dfDistrict = dfDistrict[['DistrictID', 'DDL00AM01219R']]
dfDistrict.rename(columns={'DistrictID': 'DistrictKey', 'DDL00AM01219R': 'Raw_Score'}, inplace=True)
